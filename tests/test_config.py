def test_config(config, home_dir):
    ...
    # assert config.build_args.xnat_version == "1.9.1.2"
    # assert config.build_args.xnat_cs_plugin_version == "3.6.3"
    # assert config.build_args.xnat_batch_launch_plugin_version == "0.7.1"
